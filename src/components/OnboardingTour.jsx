...
const STEPS = [
  ...
  },
  {
    icon: '💰',
    title: 'Rent Tracker',
    desc: 'The Rent Tracker shows every property's payment history as colour-coded month squares — green for paid, red for missed, amber for late. Click any square to see a day-by-day breakdown of exactly which days were covered, and hit "Day view" to see all properties at once.',
