...
const GUIDES = [
  ...
  { id: 73, cat: 'rent', title: 'Short-Term Let Income (Hostaway bookings)', tags: ['rent','stl','short-term','airbnb','hostaway','booking','occupancy','refund','adr','revpar','payout','manager','csv'],
    steps: [
      ...
      "Occupancy is the nights actually slept in the period divided by the room-nights the open rooms could have sold. A room with no Hostaway listing and no bookings counts as not yet open and sits outside the calculation. ADR is gross per night sold; RevPAR is gross per available room-night.",
      "\"By room\" ranks each room on occupancy, ADR, RevPAR and channel mix; \"On the books\" shows who is in house tonight, who arrives this week and how full the next 30 nights are.",
      "\"Manager pay run\" works out each manager's percentage for the period. \"Mark as paid\" records the payment with the figures frozen, so a later rate change cannot restate a fortnight already paid. Export CSV on the bookings, month and room tables downloads what you see.",
