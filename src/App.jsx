            ...
            {(() => {
              ...
              const SECTION_DEFS = {
                ...
                portfolio_insights: {
                  ...
                  // Scope to a single company when the filter pills have
                  // narrowed to exactly one. Empty filter (all companies)
                  // or multi-select both fall back to the portfolio-wide
                  // insights row. Widget re-fetches on companyId change.
                  render: () => {
