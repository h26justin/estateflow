...
- Footer each commit with the session link: `https://claude.ai/code/session_<id>`.
  This is the Forta convention and supersedes the generic `Co-Authored-By`
  model-name footer for this repo — keep model ids out of history.
